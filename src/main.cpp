/**
 * Original file: [XSD Download]/examples/cxx/tree/library/driver.cxx
 *
...
#include "library.hxx" // auto-generated file by XSD
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        for (auto& bi: books) {
            for (auto& ai: bi.author()) {
                author::recommends_optional& rec(ai.recommends());

                if (rec.present()) {
                    author::recommends_type& ref(rec.get());
